	...
	<div class="hamburger_menu">
		...
		<div class="hamburger_menu_content text-right">
			<ul class="menu_top_nav">
				<li class="menu_item"><a href="signin.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign In</a></li>
				<li class="menu_item"><a href="register.php"><i class="fa fa-user-plus" aria-hidden="true"></i> Register</a></li>
				...
				<div class="get_in_touch_contents">
					...
					<form method="POST" action="registerScript.php">
						<div>
							...
							<input id="input_name" class="form_input input_name input_ph" type="text" name="surname" placeholder="surname" required="required" data-error="Surname is required.">
							...
							<input id="input_name" class="form_input input_name input_ph" type="password" name="password1" placeholder="password" required="required" data-error="Password is required.">
							<input id="input_name" class="form_input input_name input_ph" type="password" name="password2" placeholder="repeat password" required="required" data-error="Password is required.">
						</div>
						<div>
							<input type="submit" class="red_button message_submit_btn trans_300" value="Create an account" name="rejestruj">
						</div>
					</form>
